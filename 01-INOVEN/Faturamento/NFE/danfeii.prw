...
If !lImpDir .or. MV_PAR04 == 0 /* Caso impressão de DANFE seja realizada via AutoDistMail */
	...
	//Impressao dos BOLETOS INOVEN
	if mv_par04 == 2 .and. !empty(Len(aNotas))	//Se notas de saida
		cBcodia := Getmv("MV_BCODIA")

		If cBcodia == "001"
			u_IFINB030(MV_PAR01,MV_PAR02,MV_PAR03)
		ElseIf cBcodia == "341"
			u_IFINB010(MV_PAR01,MV_PAR02,MV_PAR03)
		ElseIf cBcodia == "033"
			u_IFINB050(MV_PAR01,MV_PAR02,MV_PAR03)
		ElseIf cBcodia == "237"
			u_IFINB020(MV_PAR01,MV_PAR02,MV_PAR03)
		ElseIf cBcodia == "422"
			u_IFINB040(MV_PAR01,MV_PAR02,MV_PAR03)
		Endif
	endif
...
if MV_PAR04==2
	...
	EndDo
	if !empty(nCuba)
		aTransp[14] := alltrim(str(nCuba))
	endif*/
	if !empty(SF2->F2_ZCUBA)
		aTransp[14] := alltrim(str(SF2->F2_ZCUBA))
	endif
	//FIM - Cubagem
endif
...
For nZ := 1 To nLenDet
	...
	AADD(aAux, AllTrim(TransForm(nVUnit,TM(nVUnit,16,4)))) //charles 23/05/21
	...
	AADD(aAux, AllTrim(TransForm(nVTotal,TM(nVTotal,TamSX3("D2_TOTAL")[1],4))))
	...
	If ( oDet[nX]:_Prod:_uTrib:TEXT <> oDet[nX]:_Prod:_uCom:TEXT )
		...
		aAuxCom := {}
		AADD(aAuxCom, AllTrim(TransForm(,TM(nQtdTrib,TamSX3("D2_QUANT")[1],TamSX3("D2_QUANT")[2]))))
		//AADD(aAuxCom, AllTrim(TransForm(nVUnitTrib,TM(nVUnit,16,5))))    //charles 23/05/21
...
oDanfe:Say(418+nAjustaVt,387,"CUBAGEM",oFont08N:oFont)
oDanfe:Say(428+nAjustaVt,387,iif(!empty(aTransp[14]),Transform(Val(aTransp[14]),"@E 999999.99999"),""),oFont08:oFont)
