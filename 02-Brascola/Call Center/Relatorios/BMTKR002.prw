...
static function reportDef()
	...
	Local oSection1
	Local oSection2
	local cTitulo := '[REST003] - Impressão de Atendimentos
 
	oReport := TReport():New('REST003', cTitulo, , {|oReport| PrintReport(oReport)},"Este relatorio ira imprimir a relacao de atendimentos.")
	oReport:SetPortrait()
