...
If lRet == .F.
   MsgBox(OemToAnsi("Usuário sem permissão para utilizar mais de 60 dias na data de entrega  ou a data de entrega deve ser  menor que 5 dias"))
   //MsgBox(OemToAnsi("Usuário sem permissão para utilizar data de entrega > 30/08/10"))
EndIf
