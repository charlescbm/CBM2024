...
/*/
----------------------------------------------------------------------------
PROGRAMA: BESTA001         AUTOR: DÉBORA FRIEBE         DATA: 18/11/11
----------------------------------------------------------------------------

DESCRICAO: Cadastro de armazem padrao para ser utilizado em todas tabelas
relacionadas a movimento de produtos.
...
Private cCadastro := "Cadastro de Motivos de Exclusão de Notas"  
