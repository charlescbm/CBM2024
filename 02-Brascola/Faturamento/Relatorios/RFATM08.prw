...
Local cCadastro	:= OemToAnsi("Relação do faturamento diario por representante")
Local nProcessa	:= 3
Local lJob		:= .t.
...
/*
24                              6       5      4     9           36                                                    9      7
CLIENTE                         NUM.NF  PEDIDO ITEM  PRODUTO     DESCRIÇAO                                            TOTAL   EMISSAO 
...
_cBody += "      <td width='36%' align='left'   bgcolor='#ccffcc'><font face='Tahoma' size='2'>Descrição</font></td>"                                                       
