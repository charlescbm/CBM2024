...
±±ºPrograma  ³ TK070INC ºAutor  ³ Marcelo da Cunha   º Data ³  31/07/13   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Criar amarracao do Contato com o Cliente                   º±±
±±º          ³                                                            º±±
...
If (Type("__cG030CodCli") == "C").and.!Empty(SU5->U5_codcli).and.!Empty(SU5->U5_lojacli)
