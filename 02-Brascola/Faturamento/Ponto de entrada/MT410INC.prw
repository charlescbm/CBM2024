...
±±ºPrograma  ³ MT410INC ºAutor  ³ Marcelo da Cunha   º Data ³  13/06/13   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Ponto de Entrada para enviar pedido com aviso sobre itens  º±±
±±º          ³ bloqueados.                                                º±±
...
Elseif (nPerLuc < 0)
  	AAdd( oProcess:oHtml:ValByName("Item.corlin")   , "#FABEBE" )
	oProcess:oHtml:ValByName("Status", "PEDIDO "+M->C5_num+" COM RESTRIÇÕES." )
Endif                                      
