...
If lInclui .And. SF2->F2_TIPO=="D" 
	...
	Else
		...
		cTxtMail += "<body>"
		cTxtMail += "   <td><font face='Tahoma' size='2'>- A nota fiscal "+AllTrim(SF2->F2_DOC)+" da serie "+Alltrim(SF2->F2_SERIE)+" foi devolvida hoje e o cliente não possui nenhuma pendência financeira.</font></td>"
		cTxtMail += "</body>"
	EndIf
	...
	cAssuntoAx:= "N.D.F. -->  Informações adicionais sobre devolução de nota fiscal (Filial "+SF2->F2_FILIAL+")"
