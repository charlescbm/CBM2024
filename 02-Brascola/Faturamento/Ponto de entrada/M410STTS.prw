...
±±ºPrograma  ³ M410STSS ºAutor  ³ Marcelo da Cunha   º Data ³  17/06/13   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Ponto de Entrada para enviar confirmacao do pedido de vendaº±±
±±º          ³                                                            º±±
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
cSubject	:= "[EMPFIL"+cEmpAnt+cFilAnt+"PEDVEN"+SC5->C5_num+"] Confirmação do Pedido de Venda "+SC5->C5_num+" | "+dtoc(MsDate())+" as "+Substr(Time(),1,5)
...
If Empty(SC5->C5_wfenv)
	oProcess:oHtml:ValByName("Operac"  , "INCLUSÃO" )
	oProcess:oHtml:ValByName("Mensag"  , "***** Acusamos em nosso sistema o recebimento do seu Pedido de Compra. Obrigado por confiar na qualidade dos Produtos e Serviços." )
Else
	oProcess:oHtml:ValByName("Operac"  , "ALTERAÇÃO" )
	oProcess:oHtml:ValByName("Mensag"  , "***** Aviso "+SC5->C5_wfenv+" de alteração do Pedido de Compra. Obrigado por confiar na qualidade dos Produtos e Serviços." )
Endif
