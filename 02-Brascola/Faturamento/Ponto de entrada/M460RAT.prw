...
ฑฑบ Programa    ณ M460RAT  ณ Ponto de entrada na gera็ใo da nota fiscal para ajustar o    บฑฑ
ฑฑบ             ณ          ณ valor do frete pois o rateio padrใo considera todos os       บฑฑ
ฑฑบ             ณ          ณ pedidos que estใo no SC9 (sejam liberados ou bloqueados)     บฑฑ
ฑฑฬอออออออออออออุออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบ Solicitante ณ ??.08.05 ณ Levantamento                                                 บฑฑ
ฑฑฬอออออออออออออุออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบ Autor       ณ 13.09.05 ณ Almir Bandina                                                บฑฑ
ฑฑฬอออออออออออออุออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
Local aRatFrt	:= PARAMIXB				// 1o. N๚mero do Pedido
												// 2o. Item do Pedido
												// 3o. Sequencia de Libera็ใo
												// 4o. Valor do Frete
												// 5o. Valor do Seguro
												// 6o. Valor das Despesas
												// 7o. Valor do Frete Aut๔nomo
												// 8o. Valor do Desconto
												// 9o. Array com os pre็os dos itens
...
For nLoop := 1 To Len(aRatFrt)
	...
	//ณEste bloco verifica se existe valores de FRETE e SEGURO nos ณ
	//ณpedidos, para chegar num percentual e ratea-lo no pedido    ณ
	//ณque tiver sendo faturado.                                   ณ
	...
	cQry	+= " AND SC5.C5_TRANSP <> '099999'"							// hแ outros fontes tratando desta forma - rever no futuro
 ...
 //	MemoWrite("\QUERYSYS\M460RAT.SQL",cQry)
	...
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณEste bloco faz um novo rateio para os pedidos de baixo valorณ
	//ณA bonifica็ใo do frete vale apenas para pedidos na Matriz   ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
 //	If xFilial("SC5")=='01'
...
ฑฑบPrograma  ณM460RAT   บAutor  ณMicrosiga           บ Data ณ  11/30/06   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Esta funcao verifica se o pedido atende alguns requisitos  บฑฑ
ฑฑบ          ณ de estado/valor, para bonificar a cobranca do frete        บฑฑ
...
//ณEstas linhas transformam o conteudo do parametro BR_000013 em conteudo de Arrayณ 
...
While Len(cDados)>1 
	...
	If Len(aArray) > 100
		Alert("Conteudo problemแtico no parametro BR_000013")
		Return(nRet) 
	EndIf
EndDo

//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณBusca informacoes do pedido para o qual esta sendo gerado SF2ณ
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณVerifica se o estado do cliente possui o beneficio           ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณVerifica se o total do pedido recebe a bonificacao           ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณPercXFreteบAutor  ณMicrosiga           บ Data ณ  11/30/06   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Esta funcao retorna o percentual do valor cobrado a titulo บฑฑ
ฑฑบ          ณ de frete sobre o total do pedido                           บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
