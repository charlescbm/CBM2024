...
//	cNOMPRV := "HOLERITE\"+StrZero(Month(dDataRef),2)+SubStr(Str(Year(dDataRef),4),3,2)+".TXT"
	...
	aLayC:= {}
	aadd(aLayC, "0")                                       // fixo 0
	aadd(aLayC, SM0->M0_NOMECOM )                          // empresa  x(40)
	aadd(aLayC, SM0->M0_CODFIL)                            // filial  x(2)
	aadd(aLayC, SM0->M0_CGC)                               // CGC  x(14)
	aadd(aLayC, cMesAno)                                   // mes ano  x(14)
