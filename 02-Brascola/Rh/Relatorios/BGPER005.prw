...
!Nome              ! BGPER005                                                !
+------------------+---------------------------------------------------------+
!Descricao         ! Relatório de GRFC - Recolhimento Rescisorio do FGTS     !
+------------------+---------------------------------------------------------+
...
Private aOrd:= {"Matricula" , "Nome" , "Data Demissão" , "Valor a Recolher"} //array de ordenação
...
Local oReport
Local oSection1 
Local cTitulo := "GRFC-Recolhimento Rescisorio do FGTS e da Contribuição Social"
Local aTabelas:= {"SRA", "SRG", "SRR"}


oReport:= TReport():New("BGPER005",cTitulo,cPerg,{|oReport| BGPER05C(oReport)},"GRFC-Recolhimento Rescisorio do FGTS e da Contribuição Social")
oReport:SetPortrait()
...
TRCell():New(oSection1,"DEMISSAO"       ,"SRA" , "Demissão"     ,                ,  15  ,.F.   ,      ,"CENTER",  .F.     , "CENTER"   ,          ,   1     ,    .F.  ,        ,        ,     )
...
//PutSX1(cPerg , "05" , "Ordenação?"       , ""    , ""    , "mv_ch5" , "C" , 1                       , 0  , 0   , "C", ""   ,      , ""    , ""  , "mv_par05", "Matricula"   ,"      ","      ","    ","Nome"       ,"      ","      ","Data Demissão",""      ,""      ,"Valor Recolher"  ,""      ,""      ,""     ,""      ,"")
