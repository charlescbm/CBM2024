...
oBrowse:SetDescription('Cadastro de Funcionarios MVC')
oBrowse:AddLegend( "RA_SITFOLH=='D'", "YELLOW", "Desligado" )
oBrowse:AddLegend( "RA_SITFOLH=='D'", "BLUE"  , "Ativo" ) 
...
Local oStruSR6 := FWFormStruct( 1, 'SR6', /*bAvalCampo*/,/*lViewUsado*/ )
// Inicia o Model com um Model ja existente
Local oModel := FWLoadModel( 'COMP011_MVC' )
// Adiciona a nova FORMFIELD
oModel:AddFields( 'SR6MASTER', 'SR6MASTER', oStruSR6 )

// Faz relacionamento entre os compomentes do model
oModel:SetRelation( 'SR6MASTER', { { 'SR6_FILIAL', 'xFilial( "SR6" )' }, { 'SR6_TURNO', 'SRA_TNOTRAB' } }, SR6->( IndexKey( 1 ) ) )
// Adiciona a descricao do novo componente
oModel:GetModel( 'SR6MASTER' ):SetDescription( 'Complemento dos Dados de Funcionarios' )
Return oModel    
...
Local oStruSR6 := FWFormStruct( 2, 'SR6' )
...
oView:AddField( 'VIEW_SR6', oStruSR6, 'SR6MASTER' )
...
oView:SetOwnerView( 'VIEW_SR6', 'INFERIOR' )
Return oView
