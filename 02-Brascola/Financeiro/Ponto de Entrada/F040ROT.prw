...
ฑฑบPrograma  ณ F040ROT  บAutor  ณ Marcelo da Cunha   บ Data ณ  29/05/13   บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function F040ROT()
*********************
LOCAL aButtons := aClone(paramixb)
aadd(aButtons,{"Rastr.contabil","u_BF040CtbCP()",0,4})
Return aButtons

User Function BF040CtbCR()
***********************
...
cQuery += "AND CV3_TABORI = 'SE1' AND CV3_RECORI = "+Alltrim(Str(SE1->(Recno())))+" "
cQuery += " UNION "
...
cQuery += "AND CV3_TABORI = 'SE5' AND CV3_RECORI = SE5.R_E_C_N_O_ AND E5_PREFIXO = '"+SE1->E1_prefixo+"' AND E5_NUMERO = '"+SE1->E1_num+"' "
cQuery += "AND E5_PARCELA ='"+SE1->E1_parcela+"' AND E5_TIPO = '"+SE1->E1_tipo+"' AND E5_RECPAG = 'R' "
...
@ 175,010 BUTTON "Rastrear" ACTION BF040AbrirLC() SIZE 040,012 PIXEL
