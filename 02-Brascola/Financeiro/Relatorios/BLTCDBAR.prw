...
Do While !EOF()
	...
	aDadosBanco  := { SA6->A6_COD                                                   ,;// [1]Numero do Banco
	                  ...
	                  SUBSTR(SA6->A6_AGENCIA, 5, 9)                                 ,;// [3]Agência
                      SUBSTR(SA6->A6_NUMCON,5,Len(AllTrim(SA6->A6_NUMCON))-1),       ;// [4]Conta Corrente
                      ALLTRIM(SUBSTR(SA6->A6_NUMCON,Len(AllTrim(SA6->A6_NUMCON)),1)),;// [5]Dígito da conta corrente
	...
	//Aqui defino parte do numero do título. Sao 8 digitos para identificar o titulo. 
...
oPrint:Say  (nRow2+0190,100 ,"PAGAR PREFERENCIALMENTE EM AGÊNCIA DO HSBC",oFont11c)
//oPrint:Say  (nRow2+0205,400 ,"APÓS O VENCIMENTO, SOMENTE NO ITAÚ OU BANERJ",oFont10)
...
oPrint:Say  (nRow2+0250,1810,"Agência/Código Cedente:",oFont8)
...
oPrint:Say  (nRow2+0380,1350,"NÃO",oFont10)
...
oPrint:Say  (nRow2+0350,1810,"Nosso Número:",oFont8)
...
oPrint:Say  (nRow2+0420,755 ,"Espécie",oFont8)
...
oPrint:Say  (nRow2+0490,100 ,"Instruções (Texto de responsabilidade do cedente)",oFont8)
...
oPrint:Say  (nRow2+0560,1810,"(-) Outras Deduções",oFont8)
oPrint:Say  (nRow2+0630,1810,"(+) Mora/Multa",oFont8)
oPrint:Say  (nRow2+0700,1810,"(+) Outros Acréscimos",oFont8)
...
If aDatSacado[8] = "J" //Se for pessoa Jurídica
...
oPrint:Say  (nRow2+1029,1850 ,"Código de Baixa",oFont8)
...
/*
Parâmetros: 
01 cTypeBar      String com o tipo do código de barras:          
     "EAN13","EAN8","UPCA" ,"SUP5"   ,"CODE128"     
     "INT25","MAT25,"IND25","CODABAR","CODE3_9"     
02 nRow          Numero da Linha em centímetros               
03 nCol          Numero da coluna em centímetros                        
04 cCode         String com o conteúdo do código               
05 oPr           Objeto Printer                                
06 lcheck        Se calcula o digito de controle              
07 Cor           Numero da Cor, utilize a "common.ch"          
08 lHort         Se imprime na Horizontal                      
09 nWidth        Numero do Tamanho da barra em centímetros      
10 nHeigth       Numero da Altura da barra em milímetros        
11 lBanner       Se imprime o linha em baixo do código          
12 cFont         String com o tipo de fonte                    
13 cMode         String com o modo do código de barras CODE128     
...
oPrint:Say  (nRow3+2040,100 ,"PAGAR PREFERENCIALMENTE EM AGÊNCIA DO HSBC",oFont11c)
...
oPrint:Say  (nRow3+2230,1350,"NÃO",oFont10)
...
oPrint:Say  (nRow3+2855,1500,"Autenticação Mecânica",oFont8)
...
//	   HHH = Código da carteira 
//	   I   = Código do Aplicativo
