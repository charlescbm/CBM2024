...
ฑฑบPrograma  ณ BFINM001 บAutor  ณ Marcelo da Cunha   บ Data ณ  09/10/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Programa para gerar arquivo Boa Vista                      บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Monto Query para buscar Informacoes para exportar            ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
If (Right(cDir,1) != "\")
	cDir += "\"
Endif     
...
If (nHandle <= 0)
	Help("",1,"BRASCOLA",,OemToAnsi("Nใo foi possํvel gerar o arquivo "+cDir+cArq+"!"),1,0) 
	Return        
Endif
